...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo; <a href="{{url('admin/navs')}}">导航列表</a> &raquo; 添加导航
    </div>
    <!--面包屑导航 结束-->
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                           ...
                           <!--  <span><i class="fa fa-exclamation-circle yellow"></i>导航别名必须填写</span> -->
                        </td>
                    </tr>
                     <tr>
                    ...
                    <tr>
                        <th>导航排序：</th>
                        <td>
                            <input type="text" class="sm" name="nav_sort" value="0">
