            ...
            <table class="add_tab">
                <tbody>
                        ...
                        <td>
                            <select name="cate_id" style="width: 150px;">
                                @foreach($cateData as $category)
                                    <option value="{{$category->cate_id}}">{{$category->_cate_name}}</option>
                                @endforeach
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="text" class="lg" name="arc_title">
                        </td>
                    </tr>
                    <tr>
                        <th>作者：</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" size="50" name="arc_thumb">
                     ...
                     <tr>
                        <th></th>
                        <td>
                            <img src="" alt="" id="arc_thumb_img" style="max-width: 350px; max-height: 100px;">
                        </td>
                    </tr>
                    <tr>
                        <th>标签：</th>
                        <td>
                            ...
                            <label class="checkbox-inline">
                                <input type="checkbox" name="arc_tag[]" value="{{$tag->tag_id}}">{{$tag->tag_name}}
                            </label>
                            @endforeach
                        </td>
                    </tr>
                    <tr>
                        <th>博文摘要：</th>
                        <td>
                            <textarea name="arc_digest"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <th>博文内容：</th>
                ...
                <script type="text/javascript" charset="utf-8" src="{{asset('ueditor/lang/zh-cn/zh-cn.js')}}"></script>
                        <script id="editor" name="arc_content" type="text/plain" style="width:1000px;height:250px;"></script>
                        <script type="text/javascript">
